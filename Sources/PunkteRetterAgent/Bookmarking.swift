...
enum Bookmarking {
    ...
    /// Ein stale Bookmark kann noch korrekt auf die verschobene Ressource zeigen.
    /// In diesem Fall wird er unter aktivem Security Scope erneuert; ein unbrauchbarer
    /// Bookmark wird nicht durch einen Klartextpfad ersetzt.
